...
<body>
    ...
    <section class="left-side">
        ...
        <div class="content-container">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" onsubmit="return validate(event)" class="contact-us">
                <div class="text-input-wrapper">
                    <div class="line"></div>
                <input type="text" class="text-input" placeholder="Type your email address here…" name="email" id="email">
                <!-- <input type="image" src="../img/ic_arrow.svg" class="arrow" name = "submit"> -->
                <!-- <input type="submit" name="button2" value="Button2" class="submitBtn" />  -->
                <button type="submit" name="submit" style="padding: 0; border: none; width:max-content;height:14px;outline:none;"><img class="arrow" src="./img/ic_arrow.jpg" /></button>
            </div><br>
                ...
                <span class="mycheckbox"><img src="./img/ic_checkmark.png" alt=""></span><label for="checkbox">I agree to <a href="#">terms of service</a></label>
            </form>
        </div>
        <div class="success-message">
        <img src='./img/cup.png' alt='cup' class='cup'><h3>Thanks for subscribing!</h3><p>You have successfully subscribed to our email listing. Check your email for the discount code.</p>
        </div>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                if (empty($_POST["email"])) {
                    ...
                    //   echo "<div class='php-message'>$emailErr</div>";
                    echo "<noscript><div class='php-message'>$emailErr</div></noscript>";
    ...
    <section class="right-side">
        <!-- <img src="./img/image_summer.jpg" alt="summer"> -->
    </section>
</div>
